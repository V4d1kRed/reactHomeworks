...
export const SET_WINNING_PARTICIPANT = '[PARTICIPANT] Set winning participant';
...
export const setWinningParticipantAction = (payload) => ({type: SET_WINNING_PARTICIPANT, payload});
